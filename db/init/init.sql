...
-- Equipos mock
    ...
    (3,'Atletico Tucuman','https://logowik.com/content/uploads/images/atletico-tucuman1714.jpg', 'B', true),
    ...
    (9,'Defensa y Justicia','https://www.ole.com.ar/images/2021/02/02/8fhP5QZ3T_720x0__1.jpg', 'A', true),
    (10,'Deportivo Riestra','https://i.pinimg.com/564x/8a/f6/2e/8af62e56c320c4cdda7ceb3a5e8df70a.jpg', 'A', true),
    ...
    (14,'Gimnasia Mendoza','https://upload.wikimedia.org/wikipedia/commons/7/7e/Escudo_Gimnasia_y_Esgrima_Mendoza.png', 'A', true),
    ...
    (16,'Independiente','https://d22fxaf9t8d39k.cloudfront.net/ef5ba902bc4cb7d5d852f1938cdf252f647e222050a343dfdd8f53928840a258151491.jpg', 'A', true),
    ...
    (18,'Instituto','https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Escudo_Instituto_Atletico_Central_Cordoba.svg/1200px-Escudo_Instituto_Atletico_Central_Cordoba.svg.png', 'A', true),
    ...
    (21,'Platense','https://upload.wikimedia.org/wikipedia/commons/d/d4/Escudo_De_Platense.png', 'A', true),
    (22,'Racing','https://seekvectors.com/files/download/Racing%20Club%20Logo-01.png', 'B', true),
    (23,'River Plate','https://images.seeklogo.com/logo-png/43/2/escudo-river-plate-2022-logo-png_seeklogo-435015.png', 'B', true),
    (24,'Rosario Central','https://upload.wikimedia.org/wikipedia/commons/c/cc/Rosario_Central_shield.jpg', 'B', true),
    (25,'San Lorenzo','https://acdn-us.mitiendanube.com/stores/001/915/482/products/efef-bf8ae0c17fb994ae9b17375034193887-480-0.webp', 'A', true),
    (26,'Sarmiento','https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_hWya5cJp6i4-jJxzy5kEp3u1_1EzhKbiTg&s', 'B', true),
    ...
    (28,'Tigre','https://logodownload.org/wp-content/uploads/2020/03/tigre-logo-argentina-0.png', 'B', true),
    ...
    (30,'Velez Sarsfield','https://i.pinimg.com/474x/dc/a9/34/dca9342412ce267052168ecb9810341b.jpg', 'A', true);
